  ...
  updated() {
    this.$nextTick(function () {
      if (Object.keys(this.recordForEdit).length !== 0) {
        this.doctorsForm.firstname = this.recordForEdit.name; // какие ключи в базе
        this.doctorsForm.lastname = this.recordForEdit.surname; 
        this.doctorsForm.speciality = this.recordForEdit.name;
        this.doctorsForm.salary = this.recordForEdit.age; 
        this.doctorsForm.department = this.recordForEdit.surname; 
        this.isEdit=true;
      }
    })
  },
